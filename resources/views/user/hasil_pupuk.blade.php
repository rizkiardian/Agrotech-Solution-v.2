  ...
  <div class="row mb-5">
    ...
    <div class="col-lg-8 mb-4 order-1">
      <div class="card h-100">
        <img
          class="card-img-top"
          src="{{ asset("storage/images/" . $tanaman->gambar) }}"
          alt="Card image cap"
        />
        <div class="card-body">
          <h5 class="card-title text-center">Penanaman</h5>
          <p class="card-text" style="text-align: justify">
            Bibit yang sudah tumbuh daun sejati sejumlah empat helai siap
            dipindah ke lahan. Satu lubang tanam untuk satu bibit.
          </p>
          <div
            class="card-grid-container text-center"
            style="
              display: grid;
    ...
    <div class="col-md-6 col-lg-4 order-2">
      ...
      <div class="card mb-4">
        <div class="card-body text-center">
          <img
            class="card-img-top"
            src="../assets/img/elements/air.jpg"
            alt="Card image cap"
          />
