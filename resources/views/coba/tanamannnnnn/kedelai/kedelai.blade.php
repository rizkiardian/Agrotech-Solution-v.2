  ...
  <div class="row row-cols-1 row-cols-md-3 g-4">
    <div class="col-md-3 col-6">
      <div class="card h-100">
        <a href="/tahapan/?tanaman=kedelai&tahapan=pemilihan_tanaman">
          <img
            class="card-img-top"
    ...
    <div class="col-md-3 col-6">
      <div class="card h-100">
        <a href="/tahapan/?tanaman=kedelai&tahapan=persiapan_lahan">
          <img
            class="card-img-top"
    ...
    <div class="col-md-3 col-6">
      <div class="card h-100">
        <a href="/tahapan/?tanaman=kedelai&tahapan=penanaman">
          <img
            class="card-img-top"
    ...
    <div class="col-md-3 col-6">
      <div class="card h-100">
        <a href="/tahapan/?tanaman=kedelai&tahapan=pemeliharaan">
          <img
            class="card-img-top"
    ...
    <div class="col-md-3 col-6">
      <div class="card h-100">
        <a href="/tahapan/?tanaman=kedelai&tahapan=pengendalian">
          <img
            class="card-img-top"
            src="../assets/img/elements/penyakit.png"
            alt="Card image cap"
          />
          <div class="card-body">
    ...
    <div class="col-md-3 col-6">
      <div class="card h-100">
        <a href="/tahapan/?tanaman=kedelai&tahapan=panen">
          <img
            class="card-img-top"
