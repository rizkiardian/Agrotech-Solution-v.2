  ...
  <div class="col-lg-8 mb-4">
      ...
      <div class="d-flex align-items-end row">
        <div class="col-sm-7">
          <div class="card-body">
            ...
            <a href="Pemeliharaan1.html" class="btn btn-sm btn-outline-primary">Baca lebih lanjut </a>
          </div>
        </div>
        <div class="col-sm-5 text-center text-sm-left">
          <div class="card-body pb-0 px-0 px-md-4">
            <img
              src="../assets/img/elements/pemupukan.png"
              height="140"
              alt="View Badge User"
      ...
      <div class="d-flex align-items-end row">
        <div class="col-sm-7">
          <div class="card-body">
            ...
            <a href="Pemeliharaan2.html" class="btn btn-sm btn-outline-primary">Baca lebih lanjut </a>
          </div>
        </div>
        <div class="col-sm-5 text-center text-sm-left">
          <div class="card-body pb-0 px-0 px-md-4">
      ...
      <div class="d-flex align-items-end row">
        <div class="col-sm-7">
          <div class="card-body">
            ...
            <a href="Pemeliharaan3.html" class="btn btn-sm btn-outline-primary">Baca lebih lanjut </a>
          </div>
        </div>
        <div class="col-sm-5 text-center text-sm-left">
          <div class="card-body pb-0 px-0 px-md-4">
    ...
    <div class="card mb-3">
      <div class="d-flex align-items-end row">
        <div class="col-sm-7">
          <div class="card-body">
            <h5 class="card-title text-primary">Pengairan 🍀</h5>
            <p class="mb-4">
              
            </p>

            <a href="Pemiliharaan4.html" class="btn btn-sm btn-outline-primary">Baca lebih lanjut </a>
          </div>
        </div>
        <div class="col-sm-5 text-center text-sm-left">
          <div class="card-body pb-0 px-0 px-md-4">
