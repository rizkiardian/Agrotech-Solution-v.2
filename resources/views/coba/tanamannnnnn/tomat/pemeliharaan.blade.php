        ...
        <div class="d-flex align-items-end row">
          <div class="col-sm-7">
            <div class="card-body">
              ...
              <p class="mb-4">Pemasangan turus (lanjaran)</p>

              <a
                href="/pemeliharaan/?tanaman=tomat&tahapan=pemeliharaan&page=1"
        ...
        <div class="d-flex align-items-end row">
          <div class="col-sm-7">
            <div class="card-body">
              ...
              <a
                href="/pemeliharaan/?tanaman=tomat&tahapan=pemeliharaan&page=2"
                class="btn btn-sm btn-outline-primary"
              >
                Baca lebih lanjut
              </a>
        ...
        <div class="d-flex align-items-end row">
          <div class="col-sm-7">
            <div class="card-body">
              ...
              <a
                href="/pemeliharaan/?tanaman=tomat&tahapan=pemeliharaan&page=3"
                class="btn btn-sm btn-outline-primary"
              >
                Baca lebih lanjut
              </a>
        ...
        <div class="d-flex align-items-end row">
          <div class="col-sm-7">
            <div class="card-body">
              ...
              <a
                href="/pemeliharaan/?tanaman=tomat&tahapan=pemeliharaan&page=4"
                class="btn btn-sm btn-outline-primary"
              >
                Baca lebih lanjut
              </a>
