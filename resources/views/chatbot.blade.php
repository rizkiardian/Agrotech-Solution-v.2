      ...
      <div class="layout-container">
        ...
        >
          ...
          <ul class="menu-inner py-1">
            ...
            <li
              class="menu-item {{ request()->is("tanaman") ? "active" : "" }}"
            >
            ...
            <li
              class="menu-item {{ request()->is("deteksi-hama") ? "active" : "" }}"
            >
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h5 class="pb-1 mb-4"><b>Chat dengan AI</b></h5>
                  ...
                  <div class="col app-chat-history">
                    <div class="chat-history-wrapper">
                      ...
                      <div class="chat-history-body" id="chat-container">
                        <ul
                          class="list-unstyled chat-history mb-0"
                          id="chat-log"
                        >
                      ...
                      <div class="chat-history-footer">
                        ...
                        >
                          ...
                          />
                          <div
                            class="message-actions d-flex align-items-center"
                          >
                            <button
                              id="send-button"
                            ...
                            >
                              ...
                              <span
                                class="align-middle d-md-inline-block d-none"
                              >
                                Send
                              </span>
                            </button>
