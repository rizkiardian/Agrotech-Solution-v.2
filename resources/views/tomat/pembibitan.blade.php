        ...
        <div class="d-flex align-items-end row">
          <div class="col-sm-7">
            <div class="card-body">
              ...
              <p class="mb-4">Pembenihan</p>

              <a
                href="/pembibitan/?tanaman=tomat&tahapan=pembibitan&page=1"
      ...
      <div class="card mb-3">
        <div class="d-flex align-items-end row">
          <div class="col-sm-7">
            <div class="card-body">
              <h5 class="card-title text-primary">Minggu ke 2 🍀</h5>
              <p class="mb-4">Pembibitan</p>

              <a
                href="/pembibitan/?tanaman=tomat&tahapan=pembibitan&page=2"
                class="btn btn-sm btn-outline-primary"
              >
                Baca lebih lanjut
              </a>
